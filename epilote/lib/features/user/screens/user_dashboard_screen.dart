...
// ════════════════════════════════════════════════════════════════════════════
enum _Section { scolarite, finance, medical, discipline }
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Semantics(
                      label: agentName.isNotEmpty
                          ? 'Photo de profil de $agentName'
                          : 'Photo de profil',
                      image: true,
                  ...
                  // Logo de l'ÉTABLISSEMENT (où je suis) : logo école → héritage
                  // logo groupe → initiales. Voir [_SchoolLogoBadge].
                  _SchoolLogoBadge(
                    schoolLogoUrl: schoolLogoUrl,
                    groupLogoUrl: groupLogoUrl,
                    schoolName: schoolName,
