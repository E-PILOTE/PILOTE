...
Future<void> updateStudent({
  ...
  final fields = <String, dynamic>{
    ...
    if (nombreFreresSoeurs!= null) 'nombre_freres_soeurs': nombreFreresSoeurs,
    if (isBoarder         != null) 'is_boarder':           isBoarder ? 1 : 0,
    if (hasScholarship    != null) 'has_scholarship':      hasScholarship ? 1 : 0,
    if (scholarshipType   != null) 'scholarship_type':     scholarshipType,
    if (hasSocialAid      != null) 'has_social_aid':       hasSocialAid ? 1 : 0,
    if (socialAidType     != null) 'social_aid_type':      socialAidType,
