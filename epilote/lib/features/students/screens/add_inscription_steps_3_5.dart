...
class _Step3ScolariteState extends ConsumerState<_Step3Scolarite> {
  ...
  Widget build(BuildContext context) {
    ...
    final classesAsync = ref.watch(classesForModuleProvider(kSlugInscription));
...
class _Step5Resume extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final classes = ref.watch(classesForModuleProvider(kSlugInscription)).valueOrNull ?? const [];
