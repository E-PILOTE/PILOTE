...
/// Vrai quand une horloge de test est injectée : les composants animés de la
/// vitrine (anneau rotatif, halo fluorescent) figent alors leurs boucles pour
/// des captures déterministes. Accesseur PUBLIC (le hook reste `@visibleForTesting`).
